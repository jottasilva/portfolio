const tokens = {
  ...
  "fonts.headline": {
    "value": "var(--font-headline), sans-serif",
    "variable": "var(--fonts-headline)"
  },
  "fonts.body": {
    "value": "var(--font-body), sans-serif",
    "variable": "var(--fonts-body)"
  },
  "fonts.label": {
    "value": "var(--font-label), sans-serif",
    "variable": "var(--fonts-label)"
  },
  "breakpoints.sm": {
    "value": "640px",
