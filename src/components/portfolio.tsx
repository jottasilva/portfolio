       ...
       <div className="container-portfolio">
        ...
        <a href="https://www.linkedin.com/in/jrsndev" className="btn-primary">
          <svg id="Camada_1" data-name="Camada 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 81.38 82.02">
            <path fill="#fff" d="M0,82.02l7-21.22C-6.28,38.38,4.86,9.06,29.89,1.69c28.26-8.33,55.42,15.4,51.02,44.48-4.14,27.37-34.66,42.29-58.93,28.92L0,82.02ZM10.35,71.82l12.7-3.95c17.64,11.62,41.63,3.93,49.34-15.63s-4.21-40.81-24.3-44.85C22.37,2.22.99,27.18,10.19,51.82c1.05,2.8,2.52,5.26,4.11,7.77l-3.95,12.23Z"/>
            <path fill="#fff" d="M27.66,20.43c.48-.05,2.32.07,2.81.16,1.09.18,1.35.86,1.75,1.75,1.14,2.51,1.78,5.46,2.97,7.98.42,1.17-.43,2.35-1.12,3.24-.57.73-2.44,2.18-2.44,3.05,0,.52.85,1.83,1.16,2.35,2.32,3.88,5.77,7.37,9.7,9.62.63.36,3,1.65,3.56,1.77.67.14,1.09-.04,1.57-.49,1.28-1.19,2.48-2.94,3.64-4.28.79-.65,1.53-.22,2.35.11,1.95.79,6.02,2.93,7.76,4.11,1.13.77.75,2.3.51,3.5-.87,4.34-5.92,6.99-10.08,6.82-3.18-.12-10.66-3.5-13.45-5.27-7.04-4.46-18.1-17.34-16.88-26.14.39-2.86,3-7.97,6.19-8.28Z"/>
          </svg>
          Mande uma Mensagem
        </a>
